...
bal.tab(m.out.2_S,  thresholds = c(m = .25)) #all balanced, 2396/2853 treated 84%, least ppt -0.17
summary(m.out.2_S)

bal.tab(m.out.3_S,  thresholds = c(m = .25)) #all balanced, 2639/2853 treated 93%, but 1024 (ESS) control, least ppt -0.16
summary(m.out.3_S)
...
#report_grass_S_sensemakr <- ovb_minimal_reporting(grass_S_sensmakr, format = "pure_html")
#write(report_grass_S_sensemakr, file = "report_grass_S_sensemakr.html")
...
#report_agri_S_sensemakr <- ovb_minimal_reporting(agri_S_sensmakr, format = "pure_html")
#write(report_agri_S_sensemakr, file = "report_agri_S_sensemakr.html")
...
#report_forest_S_sensemakr <- ovb_minimal_reporting(forest_S_sensmakr, format = "pure_html")
#write(report_forest_S_sensemakr, file = "report_forest_S_sensemakr.html")
```
...
bal.tab(m.out.1_LS,  thresholds = c(m = .25))  #all balanced, max diff = 0.14, 4454/4557 (98%) treated
summary(m.out.1_LS)
 
bal.tab(m.out.2_LS,  thresholds = c(m = .25)) #all balanced, max diff 0.11, 4236/4557 (93%) treated
summary(m.out.2_LS)

bal.tab(m.out.3_LS,  thresholds = c(m = .25)) #all balanced, max diff 0.12, 4398/4557 (97%) treated, but only 2656 (ESS) control

bal.tab(m.out.4_LS,  thresholds = c(m = .25)) #all balanced, max diff 0.13, 4454/4557 (98%) treated
summary(m.out.4_LS)

bal.tab(m.out.5_LS,  thresholds = c(m = .25)) #all balanced, max diff 0.07, 4557/4557 (99.9%) treated, but only 638 (ESS) control 
...
#report_grass_LS_sensemakr <- ovb_minimal_reporting(grass_LS_sensmakr, format = "pure_html")
#write(report_grass_LS_sensemakr, file = "report_grass_LS_sensemakr.html")
...
#report_agri_LS_sensemakr <- ovb_minimal_reporting(agri_LS_sensmakr, format = "pure_html")
#write(report_agri_LS_sensemakr, file = "report_agri_LS_sensemakr.html")
...
#report_forest_LS_sensemakr <- ovb_minimal_reporting(forest_LS_sensmakr, format = "pure_html")
#write(report_forest_LS_sensemakr, file = "report_forest_LS_sensemakr.html")
...
# Loop through each covariate and plot the histogram
#par(mfrow = c(4, 4))  # Set plotting area for 9 plots (adjust if needed)
#for (cov in hh_COVAR_full) {
#  hist(household_sample_ALL[[cov]], main = paste("Histogram of", cov), xlab = cov)
#}


#household_sample_ALL$Log_Population <- log(household_sample_ALL$Population)
#household_sample_ALL$Log_Access <- log(household_sample_ALL$Access)
#household_sample_ALL$Log_Ethnicity1 <- log(household_sample_ALL$Ethnicity1+1)
#household_sample_ALL$Sqrt_Agriculture<- sqrt(household_sample_ALL$Agriculture)
#summary(household_sample_ALL$Log_Access)
#summary(household_sample_ALL$Log_Population)
#summary(household_sample_ALL$Sqrt_Agriculture)
#summary(household_sample_ALL$Log_Ethnicity1)
...
#Add categorical variables 
household_sample_ALL$Land <- as.factor(household_sample_ALL$Land)
household_sample_ALL$Ecoregion <- as.factor(household_sample_ALL$Ecoregion)
COVAR.ex_hh <- c( "Ecoregion") #name categorical variable
...
#Match 6: matching with genetic mahalanobis
m.out.6_hh_ALL <- matchit(as.formula(paste0("type~", paste0(hh_COVAR_full, collapse='+'))),
                         method = "genetic", distance = "mahalanobis", pop.size = 200, data = household_sample_ALL, replace = FALSE)

#Match 6: matching with genetic glm
m.out.6_hh_glm_ALL <- matchit(as.formula(paste0("type~", paste0(hh_COVAR_full, collapse='+'))),
                             method = "genetic", distance = "glm", pop.size = 200, data = household_sample_ALL, replace = FALSE)

#Match 7: matching with optimal mahalanobis
m.out.7_hh_ALL <- matchit(as.formula(paste0("type~", paste0(hh_COVAR_full, collapse='+'))),
                         method = "optimal", distance = "mahalanobis", data = household_sample_ALL, replace = FALSE)

#Match 7: matching with optimal glm
m.out.7_hh_glm_ALL <- matchit(as.formula(paste0("type~", paste0(hh_COVAR_full, collapse='+'))),
                          method = "optimal", distance = "glm", data = household_sample_ALL, replace = FALSE)

#Match 8: matching with full mahalanobis
m.out.8_hh_ALL <- matchit(as.formula(paste0("type~", paste0(hh_COVAR_full, collapse='+'))),
                         method = "full", distance = "mahalanobis", data = household_sample_ALL, replace = FALSE)

#Match 8: matching with full glm
m.out.8_hh_glm_ALL <- matchit(as.formula(paste0("type~", paste0(hh_COVAR_full, collapse='+'))),
                          method = "full", distance = "glm", data = household_sample_ALL, replace = FALSE)
```
...
bal.tab(m.out.2_hh_ALL,  thresholds = c(m = .25)) #75% all balanced 0.11
summary(m.out.2_hh_ALL)
...
bal.tab(m.out.6_hh_ALL,  thresholds = c(m = .25))

bal.tab(m.out.6_hh_glm_ALL,  thresholds = c(m = .25)) 

bal.tab(m.out.7_hh_ALL,  thresholds = c(m = .25)) 

bal.tab(m.out.7_hh_glm_ALL,  thresholds = c(m = .25))

bal.tab(m.out.8_hh_ALL,  thresholds = c(m = .25))

bal.tab(m.out.8_hh_glm_ALL,  thresholds = c(m = .25))
...
#report_mins_hh_sensmakr <- ovb_minimal_reporting(mins_hh_sensmakr, format = "pure_html")
#write(report_mins_hh_sensmakr, file = "report_mins_hh_sensmakr.html")
...
#report_hdds_hh_sensmakr <- ovb_minimal_reporting(hdds_hh_sensmakr, format = "pure_html")
#write(report_hdds_hh_sensmakr, file = "report_hdds_hh_sensmakr.html")
...
#report_asset_hh_sensmakr <- ovb_minimal_reporting(asset_hh_sensmakr, format = "pure_html")
#write(report_asset_hh_sensmakr, file = "report_asset_hh_sensmakr.html")
```
...
avr_forest2000_S <- summarySE(final_data_S, measurevar="Forest_2000", groupvars=c("type"))
avr_forest2000_LS <- summarySE(final_data_LS, measurevar="Forest_2000", groupvars=c("type"))
avr_agri2000_S <- summarySE(final_data_S, measurevar="Agri_03", groupvars=c("type"))
avr_agri2000_LS <- summarySE(final_data_LS, measurevar="Agri_03", groupvars=c("type"))
avr_grass2000_S <- summarySE(final_data_S, measurevar="Grass_2001", groupvars=c("type"))
avr_grass2000_LS <- summarySE(final_data_LS, measurevar="Grass_2001", groupvars=c("type"))
avr_MINS_2011 <- summarySE(hh_matched_outputs, measurevar = "MINS_2011", groupvars = c("type"))
avr_HDDS_2011 <-  summarySE(hh_matched_outputs, measurevar = "HDDS_2011", groupvars = c("type"))
avr_asset_2011 <- summarySE(hh_matched_outputs, measurevar = "SES_Index_2011", groupvars = c("type"))
```
